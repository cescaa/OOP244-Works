...
int main()
{
   int i;
   Canister C[] = {
       Canister(),                    // constructor calls 0
       Canister(nullptr),             // 1
       Canister("Orange Juice"),      // 2
       Canister(40, 30),              // 3
       Canister(20, 10, "Olive Oil"), // 4
   ...
   // Title of table: "Five good ones and 4 bad ones:"
   // Canister class object Array: C (used to dsiplaty row of objs)
   // Number of rows to display: 9
