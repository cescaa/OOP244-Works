...
namespace sdds
{
   ...
   public:
      ...
      bool operator==(const Date &rightObj) const; // const at the end ensures method does not modify
      bool operator!=(const Date &rightObj) const;
      bool operator>=(const Date &rightObj) const;
      bool operator<=(const Date &rightObj) const;
      bool operator<(const Date &rightObj) const;
      bool operator>(const Date &rightObj) const;
      int operator-(const Date &rightObj) const;
      operator bool() const;
